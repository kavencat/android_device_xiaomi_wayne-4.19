...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_7_0.xml \
    $(LOCAL_PATH)/configs/audio/audio_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer.txt \
    $(LOCAL_PATH)/configs/audio/graphite_ipc_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/graphite_ipc_platform_info.xml \
    $(LOCAL_PATH)/configs/audio/listen_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/listen_platform_info.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_intcodec.xml \
...
# IRSC
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/others/sec_config:$(TARGET_COPY_OUT_VENDOR)/etc/sec_config
...
# Permissions
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/others/system_ext-privapp-permissions-qti.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-qti.xml
...
# Public Libraries
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/others/public.libraries.txt:$(TARGET_COPY_OUT_VENDOR)/etc/public.libraries.txt
